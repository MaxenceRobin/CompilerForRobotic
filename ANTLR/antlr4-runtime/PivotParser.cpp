...
std::vector<PivotParser::Numeric_powContext *> PivotParser::Numeric_powContext::numeric_pow() {
  return getRuleContexts<PivotParser::Numeric_powContext>();
}

PivotParser::Numeric_powContext* PivotParser::Numeric_powContext::numeric_pow(size_t i) {
  return getRuleContext<PivotParser::Numeric_powContext>(i);
}
  ...
  try {
    ...
    switch (_input->LA(1)) {
      ...
      case PivotParser::MATH: {
        ...
        setState(88);
        dynamic_cast<Numeric_powContext *>(_localctx)->first = numeric_pow();
        setState(89);
        match(PivotParser::COMMA);
        setState(90);
        dynamic_cast<Numeric_powContext *>(_localctx)->second = numeric_pow();
        setState(91);
...
PivotParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x2, 0x59, 0x5a, 0x7, 0xe, 0x2, 0x2, 0x5a, 0x5b, 0x5, 0x10, 0x9, 0x2, 
    0x5b, 0x5c, 0x7, 0x15, 0x2, 0x2, 0x5c, 0x5d, 0x5, 0x10, 0x9, 0x2, 0x5d, 
